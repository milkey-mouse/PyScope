...
viewer = wd.WireframeViewer(width, height, "PyScope")

viewer.addWireframe('floor',   bs.HorizontalGrid((0,400,0), (40,40), (10,10)))
viewer.addWireframe('ceiling', bs.HorizontalGrid((0,250,0), (40,40), (10,10)))
viewer.addWireframe('back wall',  bs.Cuboid((-10,250,400), (420,150, 10)))
viewer.addWireframe('left wall',  bs.Cuboid((-10,250,  0), ( 10,150,400)))
viewer.addWireframe('right wall', bs.Cuboid((400,250,  0), ( 10,150,400)))
viewer.addWireframe('back block', bs.Cuboid((125,250,200), (150,150,200)))
